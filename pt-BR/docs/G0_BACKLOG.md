...
- O limite de runtime DRI3 está registrado nas duas árvores de idioma: esta estação possui nós de renderização, mas a execução isolada autorizada foi bloqueada pelo lock gráfico compartilhado, e o wrapper baseado em Xvfb não pode fornecer apresentação.
