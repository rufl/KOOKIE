...
autenticado, provisionamento explícito de chave não nula antes da abertura,
congelamento após ativação, validação de sequência/tamanho, palavras com sinal e
timeout de recebimento de 1.000 ms, além de estados explícitos de recuperação
GPU e bitmask de capacidades para reopen limpo e marcador de perda. Em seguida:
adicionar apresentação isolada
