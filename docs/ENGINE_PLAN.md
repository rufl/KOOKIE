...
- Separate immutable `WeaponDef` from runtime magazine/reload/cooldown/spin/burst state and item-instance modifiers. Hitscan, swept projectile and bounded multi-target area damage now share authoritative query/damage paths; shotgun spread remains a planned extension.
