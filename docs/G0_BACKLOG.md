...
- Replay checkpoints now scale to 256 bounded snapshot values; JVM/native coverage verifies enemy combat, AI, spatial and encounter state rewind through the loopback checkpoint path.
