...
- Replay checkpoints now scale to 320 bounded snapshot values and restore enemy spatial projectiles while clearing transient impact presentation/audio queues; JVM/native coverage verifies enemy combat, AI, spatial, projectile and encounter state rewind through the loopback checkpoint path.
