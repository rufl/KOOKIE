...
- Replay checkpoints now scale to 256 bounded snapshot values; JVM/native coverage verifies enemy combat health and ammunition rewind through the loopback checkpoint path.
