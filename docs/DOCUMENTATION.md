...
Every public page and document has two maintained forms:

- English: the canonical path under `README.md` or `docs/`.
- Brazilian Portuguese: the matching path under `pt-BR/` or `pt-BR/docs/`.
