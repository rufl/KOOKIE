...
- Added a reproducible Linux x86-64 dogfood archive builder with provenance, SHA256SUMS and extracted-binary smoke. Windows packaging fails closed until Kof exposes a real PE target and signing/runtime proof; the archive is internal-only because KOOKIE has no declared license or OVERZEER application registration.
